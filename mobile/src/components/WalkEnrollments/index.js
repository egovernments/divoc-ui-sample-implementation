    ...
    if (pageName === state.nextForm) {
        switch (pageName) {
            ...
            case FORM_WALK_IN_ENROLL_FORM:
                ...
                return <RegisterBeneficiaryForm onContinue={onFormContinue} buttonText={getMessageComponent(LANGUAGE_KEYS.BUTTON_CONTINUE)} />;
            case FORM_WALK_IN_VERIFY_FORM:
                ...
                return <RegisterBeneficiaryForm verifyDetails={true} onBack={onBack} onContinue={onContinue} buttonText={getMessageComponent(LANGUAGE_KEYS.BUTTON_CONFIRM)}/>;
